...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'truck_automatic_ctrl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kem/Desktop/ChalmersKandidat/Kandidat19/catkin_ws_clean/install/${idir}'.  ${_report}")
    endif()
